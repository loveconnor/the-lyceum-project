...
import { resolveCodeBlockIcon } from "../ui/svgs";
...
interface CodeBlockIconProps extends ComponentProps<"svg"> {
  language?: string;
}

const CodeBlockIcon = ({ language, className, ...props }: CodeBlockIconProps) => {
  const Icon = resolveCodeBlockIcon(language);
