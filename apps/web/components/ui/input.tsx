  ...
  return (
    ...
    >
      <InputPrimitive
        data-slot="input"
        className={cn(
          "w-full min-w-0 appearance-none rounded-[inherit] border-0 bg-transparent px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] shadow-none outline-none placeholder:text-muted-foreground/64",
          size === "sm" &&
