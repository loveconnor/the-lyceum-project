...
export default function LabViewer({ lab }: LabViewerProps) {
  const { template_type, template_data } = lab;

  // Render the appropriate template based on type
  switch (template_type) {
    case "analyze":
      return <AnalyzeTemplate data={template_data as any} labId={lab.id} />;
    case "build":
      return <BuildTemplate data={template_data as any} labId={lab.id} />;
    case "derive":
      return <DeriveTemplate data={template_data as any} labId={lab.id} />;
    case "explain":
      return <ExplainTemplate data={template_data as any} labId={lab.id} />;
    case "explore":
      return <ExploreTemplate data={template_data as any} labId={lab.id} />;
    case "revise":
      return <ReviseTemplate data={template_data as any} labId={lab.id} />;
    default:
      return (
