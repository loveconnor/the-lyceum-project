...
exports.createLearningReminder = createLearningReminder;
exports.createPathCompletionNotification = createPathCompletionNotification;
exports.createLabCompletionNotification = createLabCompletionNotification;
exports.createModuleCompletionNotification = createModuleCompletionNotification;
exports.createAlmostDoneNotification = createAlmostDoneNotification;
exports.generateInactivityReminders = generateInactivityReminders;
 ...
 */
async function createLearningReminder(userId, pathId, pathTitle, daysSinceActivity) {
 ...
 */
async function createPathCompletionNotification(userId, pathId, pathTitle) {
    return createNotification({
        userId,
 ...
 */
async function createLabCompletionNotification(userId, labId, labTitle) {
    return createNotification({
        userId,
        type: 'lab_completion',
        title: 'Lab Completed!',
 ...
 */
async function createModuleCompletionNotification(userId, moduleId, moduleTitle, pathId) {
    return createNotification({
        userId,
 ...
 */
async function createAlmostDoneNotification(userId, pathId, pathTitle, remainingItems) {
    return createNotification({
        userId,
        type: 'learning_reminder',
        title: 'Almost There!',
 ...
 */
async function generateInactivityReminders() {
    try {
        const supabase = (0, supabaseAdmin_1.getSupabaseAdmin)();
        ...
        for (const path of inProgressPaths || []) {
            ...
            if (daysSinceActivity >= 3) {
                ...
                if (!recentReminders || recentReminders.length === 0) {
                    await createLearningReminder(path.user_id, path.id, path.title, daysSinceActivity);
                }
            }
        }
    }
